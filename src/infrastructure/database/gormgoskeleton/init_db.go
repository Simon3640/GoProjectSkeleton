...
// func SetUpModel(db *gorm.DB, model T, defaults any, logger contracts.ILoggerProvider, name string) {
...
// 				if err := db.Table(model.TableName()).Create(item).Error; err != nil {
...
// } // TODO: Refactor function to use constructor
