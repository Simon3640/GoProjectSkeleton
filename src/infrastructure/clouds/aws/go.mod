...
replace github.com/simon3640/goprojectskeleton/src/infrastructure/otel => ../../otel
...
require (
	...
	github.com/simon3640/goprojectskeleton/src/infrastructure/otel v0.0.0-00010101000000-000000000000
)
