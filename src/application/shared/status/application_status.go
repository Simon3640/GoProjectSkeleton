...
const (
	...
	DatabaseInitializationError      ApplicationStatusEnum = "DB_INI_ER"
	ConfigurationInitializationError ApplicationStatusEnum = "CF_INI_ER"
	ApplicationInitializationError   ApplicationStatusEnum = "AP_INI_ER"
	ProviderInitializationError      ApplicationStatusEnum = "PR_INI_ER"
)
